...
const technologies = [
  ...
  {
    name: "Javascript",
    img: "https://i.postimg.cc/pV8Gjck0/pngwing-com-4.png",
  },
  ...
  {
    name: "NextJs",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Nextjs-logo.svg/2560px-Nextjs-logo.svg.png",
  },
  {
    name: "NodeJs",
    img: "https://i.postimg.cc/q7ZmFBm8/kisspng-website-development-logo-node-js-scalable-vector-g-jet-5b643ebeb2d093-6340612715332963187324.png",
  },
  {
    name: "Express",
    img: "https://i.postimg.cc/9ff81wBm/kisspng-young-death-nightmarket-marketing-funeral-home-b-5b4cfe39c349a6-8584522715317724737999.png",
  },
];
    ...
    >
      ...
      <Grid container mt={5} display="flex" alingItems="center">
        {technologies.map((tech) => (
          <CardTech key={tech.name} technologie={tech}></CardTech>
        ))}
      </Grid>
      ...
      <Typography
        ...
        md={12}
        mt={5}
        sx={{ color: "#A0A0A0", letterSpacing: "1px" }}
        fontSize="1.2rem"
        variant="span"
      >
        <Box
