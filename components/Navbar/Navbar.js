...
const Navbar = () => {
  ...
  return (
    <>
      <Grid id="init" p={3} container display="flex">
        <Grid item md={6} display="flex" alignItems="center">
          ...
          >
            <Link href="#init" sx={styleLink}>
              {" "}
              Inicio{" "}
            </Link>
            <Link href="#skills" sx={styleLink}>
              {" "}
              Habilidades
            </Link>
            <Link href="#projects" sx={styleLink}>
              {" "}
              Proyectos{" "}
            </Link>
            <Link
              ...
              sx={{
                ...styleLink,
                borderImage:
                  "linear-gradient(to right, #993488 0%, #5E30AF 100%) 1",
              }}
            >
              {" "}
              Contactame{" "}
